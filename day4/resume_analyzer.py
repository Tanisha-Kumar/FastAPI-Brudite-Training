...
def extract_info_from_llm(md_content:str)->dict:
    ...
    try:
        ...
        return structured_data  #llm response in json form
...
def analyzing_pipeline(md_list: list)-> dict:
    """this function will take list of markdowns as input and return a dictionary of analysed results"""
